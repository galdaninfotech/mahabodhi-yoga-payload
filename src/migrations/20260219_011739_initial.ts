...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_newsletter_logs_status" AS ENUM('success', 'failed');
  ...
  CREATE TYPE "public"."enum_payload_jobs_log_task_slug" AS ENUM('inline', 'sendNewsletterEmail', 'schedulePublish');
  CREATE TYPE "public"."enum_payload_jobs_log_state" AS ENUM('failed', 'succeeded');
  CREATE TYPE "public"."enum_payload_jobs_task_slug" AS ENUM('inline', 'sendNewsletterEmail', 'schedulePublish');
  CREATE TYPE "public"."enum_header_nav_items_sub_menu_items_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_header_nav_items_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_footer_more_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_settings_newsletter_subscriber_group_mode" AS ENUM('single', 'multiple');
  ...
  CREATE TABLE "pages_blocks_client_testimonials_testimonials" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE "pages_blocks_client_testimonials" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "pages_blocks_newsletter_subscription_notes" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"note" varchar
  ...
  CREATE TABLE "pages_blocks_newsletter_subscription" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	...
  	"title" varchar,
  	"subtitle" varchar,
  	"show_name_field" boolean DEFAULT false,
  	"media_id" integer,
  	"description" jsonb,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "pages_blocks_list_one_lists" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE "pages_blocks_list_one" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"enabled" boolean DEFAULT true,
  	"margin_top" varchar DEFAULT '25px',
  	"margin_left" varchar DEFAULT '20px',
  	"space" varchar DEFAULT '10px',
  	"block_name" varchar
  );
  
  CREATE TABLE "pages_blocks_list_two_lists" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE "pages_blocks_list_two" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "pages_blocks_paragraph_one" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "pages_blocks_block_quote" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "pages_blocks_address" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "pages_blocks_about_us_list" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"item" varchar
  ...
  CREATE TABLE "pages_blocks_about_us" (
  	...
  	"meditation_instructors" numeric,
  	"courses_available" numeric,
  	"satisfied_clients" numeric,
  	"block_name" varchar
  );
  
  CREATE TABLE "pages_blocks_accordion_accordion" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE "pages_blocks_you_tube_video" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_client_testimonials_testimonials" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE "_pages_v_blocks_client_testimonials" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_newsletter_subscription_notes" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"note" varchar,
  ...
  CREATE TABLE "_pages_v_blocks_newsletter_subscription" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_list_one_lists" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE "_pages_v_blocks_list_one" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_list_two_lists" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE "_pages_v_blocks_list_two" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_paragraph_one" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_block_quote" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_address" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_about_us_list" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"item" varchar,
  ...
  CREATE TABLE "_pages_v_blocks_accordion_accordion" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE "_pages_v_blocks_you_tube_video" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "newsletters_populated_authors" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"name" varchar
  ...
  CREATE TABLE "_newsletters_v_version_populated_authors" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_uuid" varchar,
  ...
  CREATE TABLE "_newsletters_v" (
  	...
  	"version_hero_image_id" integer,
  	"version_content" jsonb,
  	"version_predesigned_p_d_f_id" integer,
  	"version_published_at" timestamp(3) with time zone,
  	"version_slug" varchar,
  ...
  CREATE TABLE "newsletter_logs" (
  	...
  	"status" "enum_newsletter_logs_status" NOT NULL,
  ...
  CREATE TABLE "header_nav_items_sub_menu_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_header_nav_items_sub_menu_items_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  ...
  CREATE TABLE "footer_more_links" (
  	...
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_footer_more_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar NOT NULL
  );
  ...
  CREATE TABLE "settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"newsletter_subscriber_group_mode" "enum_settings_newsletter_subscriber_group_mode" DEFAULT 'single',
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  
  CREATE TABLE "sambodhi_retreat_centre" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"name" varchar,
  	"slogan" varchar,
  ...
  ALTER TABLE "pages_blocks_client_testimonials_testimonials" ADD CONSTRAINT "pages_blocks_client_testimonials_testimonials_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_client_testimonials"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_client_testimonials" ADD CONSTRAINT "pages_blocks_client_testimonials_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_newsletter_subscription_notes" ADD CONSTRAINT "pages_blocks_newsletter_subscription_notes_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_newsletter_subscription"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_newsletter_subscription" ADD CONSTRAINT "pages_blocks_newsletter_subscription_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_list_one_lists" ADD CONSTRAINT "pages_blocks_list_one_lists_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_list_one"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_list_one" ADD CONSTRAINT "pages_blocks_list_one_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_list_two_lists" ADD CONSTRAINT "pages_blocks_list_two_lists_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_list_two"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_list_two" ADD CONSTRAINT "pages_blocks_list_two_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_paragraph_one" ADD CONSTRAINT "pages_blocks_paragraph_one_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_block_quote" ADD CONSTRAINT "pages_blocks_block_quote_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_address" ADD CONSTRAINT "pages_blocks_address_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_about_us_list" ADD CONSTRAINT "pages_blocks_about_us_list_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_about_us"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_about_us" ADD CONSTRAINT "pages_blocks_about_us_image1_id_media_id_fk" FOREIGN KEY ("image1_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_accordion_accordion" ADD CONSTRAINT "pages_blocks_accordion_accordion_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_accordion"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_you_tube_video" ADD CONSTRAINT "pages_blocks_you_tube_video_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_client_testimonials_testimonials" ADD CONSTRAINT "_pages_v_blocks_client_testimonials_testimonials_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_client_testimonials"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_client_testimonials" ADD CONSTRAINT "_pages_v_blocks_client_testimonials_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_newsletter_subscription_notes" ADD CONSTRAINT "_pages_v_blocks_newsletter_subscription_notes_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_newsletter_subscription"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_newsletter_subscription" ADD CONSTRAINT "_pages_v_blocks_newsletter_subscription_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_list_one_lists" ADD CONSTRAINT "_pages_v_blocks_list_one_lists_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_list_one"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_list_one" ADD CONSTRAINT "_pages_v_blocks_list_one_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_list_two_lists" ADD CONSTRAINT "_pages_v_blocks_list_two_lists_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_list_two"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_list_two" ADD CONSTRAINT "_pages_v_blocks_list_two_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_paragraph_one" ADD CONSTRAINT "_pages_v_blocks_paragraph_one_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_block_quote" ADD CONSTRAINT "_pages_v_blocks_block_quote_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_address" ADD CONSTRAINT "_pages_v_blocks_address_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_about_us_list" ADD CONSTRAINT "_pages_v_blocks_about_us_list_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_about_us"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_about_us" ADD CONSTRAINT "_pages_v_blocks_about_us_image1_id_media_id_fk" FOREIGN KEY ("image1_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_accordion_accordion" ADD CONSTRAINT "_pages_v_blocks_accordion_accordion_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_accordion"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_you_tube_video" ADD CONSTRAINT "_pages_v_blocks_you_tube_video_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "newsletters_populated_authors" ADD CONSTRAINT "newsletters_populated_authors_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."newsletters"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "newsletters" ADD CONSTRAINT "newsletters_hero_image_id_media_id_fk" FOREIGN KEY ("hero_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "newsletters" ADD CONSTRAINT "newsletters_predesigned_p_d_f_id_media_id_fk" FOREIGN KEY ("predesigned_p_d_f_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "newsletters_rels" ADD CONSTRAINT "newsletters_rels_users_fk" FOREIGN KEY ("users_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_newsletters_v_version_populated_authors" ADD CONSTRAINT "_newsletters_v_version_populated_authors_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_newsletters_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_newsletters_v" ADD CONSTRAINT "_newsletters_v_version_hero_image_id_media_id_fk" FOREIGN KEY ("version_hero_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_newsletters_v" ADD CONSTRAINT "_newsletters_v_version_predesigned_p_d_f_id_media_id_fk" FOREIGN KEY ("version_predesigned_p_d_f_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_newsletters_v_rels" ADD CONSTRAINT "_newsletters_v_rels_users_fk" FOREIGN KEY ("users_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "subscribers_rels" ADD CONSTRAINT "subscribers_rels_subscriber_groups_fk" FOREIGN KEY ("subscriber_groups_id") REFERENCES "public"."subscriber_groups"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "newsletter_logs" ADD CONSTRAINT "newsletter_logs_newsletter_id_newsletters_id_fk" FOREIGN KEY ("newsletter_id") REFERENCES "public"."newsletters"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "newsletter_logs" ADD CONSTRAINT "newsletter_logs_subscriber_id_subscribers_id_fk" FOREIGN KEY ("subscriber_id") REFERENCES "public"."subscribers"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_subscriber_groups_fk" FOREIGN KEY ("subscriber_groups_id") REFERENCES "public"."subscriber_groups"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_newsletter_logs_fk" FOREIGN KEY ("newsletter_logs_id") REFERENCES "public"."newsletter_logs"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "header_nav_items_sub_menu_items" ADD CONSTRAINT "header_nav_items_sub_menu_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."header_nav_items"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "header_nav_items" ADD CONSTRAINT "header_nav_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."header"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "header_rels" ADD CONSTRAINT "header_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."header"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "header_rels" ADD CONSTRAINT "header_rels_pages_fk" FOREIGN KEY ("pages_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "footer_more_links" ADD CONSTRAINT "footer_more_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."footer"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_client_testimonials_testimonials_order_idx" ON "pages_blocks_client_testimonials_testimonials" USING btree ("_order");
  CREATE INDEX "pages_blocks_client_testimonials_testimonials_parent_id_idx" ON "pages_blocks_client_testimonials_testimonials" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_client_testimonials_order_idx" ON "pages_blocks_client_testimonials" USING btree ("_order");
  CREATE INDEX "pages_blocks_client_testimonials_parent_id_idx" ON "pages_blocks_client_testimonials" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_client_testimonials_path_idx" ON "pages_blocks_client_testimonials" USING btree ("_path");
  CREATE INDEX "pages_blocks_newsletter_subscription_notes_order_idx" ON "pages_blocks_newsletter_subscription_notes" USING btree ("_order");
  CREATE INDEX "pages_blocks_newsletter_subscription_notes_parent_id_idx" ON "pages_blocks_newsletter_subscription_notes" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_newsletter_subscription_order_idx" ON "pages_blocks_newsletter_subscription" USING btree ("_order");
  CREATE INDEX "pages_blocks_newsletter_subscription_parent_id_idx" ON "pages_blocks_newsletter_subscription" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_newsletter_subscription_path_idx" ON "pages_blocks_newsletter_subscription" USING btree ("_path");
  CREATE INDEX "pages_blocks_newsletter_subscription_media_idx" ON "pages_blocks_newsletter_subscription" USING btree ("media_id");
  ...
  CREATE INDEX "pages_blocks_list_one_lists_order_idx" ON "pages_blocks_list_one_lists" USING btree ("_order");
  CREATE INDEX "pages_blocks_list_one_lists_parent_id_idx" ON "pages_blocks_list_one_lists" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_list_one_order_idx" ON "pages_blocks_list_one" USING btree ("_order");
  CREATE INDEX "pages_blocks_list_one_parent_id_idx" ON "pages_blocks_list_one" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_list_one_path_idx" ON "pages_blocks_list_one" USING btree ("_path");
  CREATE INDEX "pages_blocks_list_two_lists_order_idx" ON "pages_blocks_list_two_lists" USING btree ("_order");
  CREATE INDEX "pages_blocks_list_two_lists_parent_id_idx" ON "pages_blocks_list_two_lists" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_list_two_order_idx" ON "pages_blocks_list_two" USING btree ("_order");
  CREATE INDEX "pages_blocks_list_two_parent_id_idx" ON "pages_blocks_list_two" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_list_two_path_idx" ON "pages_blocks_list_two" USING btree ("_path");
  CREATE INDEX "pages_blocks_paragraph_one_order_idx" ON "pages_blocks_paragraph_one" USING btree ("_order");
  CREATE INDEX "pages_blocks_paragraph_one_parent_id_idx" ON "pages_blocks_paragraph_one" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_paragraph_one_path_idx" ON "pages_blocks_paragraph_one" USING btree ("_path");
  CREATE INDEX "pages_blocks_block_quote_order_idx" ON "pages_blocks_block_quote" USING btree ("_order");
  CREATE INDEX "pages_blocks_block_quote_parent_id_idx" ON "pages_blocks_block_quote" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_block_quote_path_idx" ON "pages_blocks_block_quote" USING btree ("_path");
  CREATE INDEX "pages_blocks_address_order_idx" ON "pages_blocks_address" USING btree ("_order");
  CREATE INDEX "pages_blocks_address_parent_id_idx" ON "pages_blocks_address" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_address_path_idx" ON "pages_blocks_address" USING btree ("_path");
  ...
  CREATE INDEX "pages_blocks_about_us_list_order_idx" ON "pages_blocks_about_us_list" USING btree ("_order");
  CREATE INDEX "pages_blocks_about_us_list_parent_id_idx" ON "pages_blocks_about_us_list" USING btree ("_parent_id");
  ...
  CREATE INDEX "pages_blocks_about_us_image1_idx" ON "pages_blocks_about_us" USING btree ("image1_id");
  CREATE INDEX "pages_blocks_accordion_accordion_order_idx" ON "pages_blocks_accordion_accordion" USING btree ("_order");
  CREATE INDEX "pages_blocks_accordion_accordion_parent_id_idx" ON "pages_blocks_accordion_accordion" USING btree ("_parent_id");
  ...
  CREATE INDEX "pages_blocks_you_tube_video_order_idx" ON "pages_blocks_you_tube_video" USING btree ("_order");
  CREATE INDEX "pages_blocks_you_tube_video_parent_id_idx" ON "pages_blocks_you_tube_video" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_you_tube_video_path_idx" ON "pages_blocks_you_tube_video" USING btree ("_path");
  ...
  CREATE INDEX "_pages_v_blocks_client_testimonials_testimonials_order_idx" ON "_pages_v_blocks_client_testimonials_testimonials" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_client_testimonials_testimonials_parent_id_idx" ON "_pages_v_blocks_client_testimonials_testimonials" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_client_testimonials_order_idx" ON "_pages_v_blocks_client_testimonials" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_client_testimonials_parent_id_idx" ON "_pages_v_blocks_client_testimonials" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_client_testimonials_path_idx" ON "_pages_v_blocks_client_testimonials" USING btree ("_path");
  CREATE INDEX "_pages_v_blocks_newsletter_subscription_notes_order_idx" ON "_pages_v_blocks_newsletter_subscription_notes" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_newsletter_subscription_notes_parent_id_idx" ON "_pages_v_blocks_newsletter_subscription_notes" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_newsletter_subscription_order_idx" ON "_pages_v_blocks_newsletter_subscription" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_newsletter_subscription_parent_id_idx" ON "_pages_v_blocks_newsletter_subscription" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_newsletter_subscription_path_idx" ON "_pages_v_blocks_newsletter_subscription" USING btree ("_path");
  CREATE INDEX "_pages_v_blocks_newsletter_subscription_media_idx" ON "_pages_v_blocks_newsletter_subscription" USING btree ("media_id");
  ...
  CREATE INDEX "_pages_v_blocks_list_one_lists_order_idx" ON "_pages_v_blocks_list_one_lists" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_list_one_lists_parent_id_idx" ON "_pages_v_blocks_list_one_lists" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_list_one_order_idx" ON "_pages_v_blocks_list_one" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_list_one_parent_id_idx" ON "_pages_v_blocks_list_one" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_list_one_path_idx" ON "_pages_v_blocks_list_one" USING btree ("_path");
  CREATE INDEX "_pages_v_blocks_list_two_lists_order_idx" ON "_pages_v_blocks_list_two_lists" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_list_two_lists_parent_id_idx" ON "_pages_v_blocks_list_two_lists" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_list_two_order_idx" ON "_pages_v_blocks_list_two" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_list_two_parent_id_idx" ON "_pages_v_blocks_list_two" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_list_two_path_idx" ON "_pages_v_blocks_list_two" USING btree ("_path");
  CREATE INDEX "_pages_v_blocks_paragraph_one_order_idx" ON "_pages_v_blocks_paragraph_one" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_paragraph_one_parent_id_idx" ON "_pages_v_blocks_paragraph_one" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_paragraph_one_path_idx" ON "_pages_v_blocks_paragraph_one" USING btree ("_path");
  CREATE INDEX "_pages_v_blocks_block_quote_order_idx" ON "_pages_v_blocks_block_quote" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_block_quote_parent_id_idx" ON "_pages_v_blocks_block_quote" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_block_quote_path_idx" ON "_pages_v_blocks_block_quote" USING btree ("_path");
  CREATE INDEX "_pages_v_blocks_address_order_idx" ON "_pages_v_blocks_address" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_address_parent_id_idx" ON "_pages_v_blocks_address" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_address_path_idx" ON "_pages_v_blocks_address" USING btree ("_path");
  ...
  CREATE INDEX "_pages_v_blocks_about_us_list_order_idx" ON "_pages_v_blocks_about_us_list" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_about_us_list_parent_id_idx" ON "_pages_v_blocks_about_us_list" USING btree ("_parent_id");
  ...
  CREATE INDEX "_pages_v_blocks_about_us_image1_idx" ON "_pages_v_blocks_about_us" USING btree ("image1_id");
  CREATE INDEX "_pages_v_blocks_accordion_accordion_order_idx" ON "_pages_v_blocks_accordion_accordion" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_accordion_accordion_parent_id_idx" ON "_pages_v_blocks_accordion_accordion" USING btree ("_parent_id");
  ...
  CREATE INDEX "_pages_v_blocks_you_tube_video_order_idx" ON "_pages_v_blocks_you_tube_video" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_you_tube_video_parent_id_idx" ON "_pages_v_blocks_you_tube_video" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_you_tube_video_path_idx" ON "_pages_v_blocks_you_tube_video" USING btree ("_path");
  ...
  CREATE INDEX "newsletters_populated_authors_order_idx" ON "newsletters_populated_authors" USING btree ("_order");
  CREATE INDEX "newsletters_populated_authors_parent_id_idx" ON "newsletters_populated_authors" USING btree ("_parent_id");
  CREATE INDEX "newsletters_hero_image_idx" ON "newsletters" USING btree ("hero_image_id");
  CREATE INDEX "newsletters_predesigned_p_d_f_idx" ON "newsletters" USING btree ("predesigned_p_d_f_id");
  ...
  CREATE INDEX "newsletters_rels_users_id_idx" ON "newsletters_rels" USING btree ("users_id");
  CREATE INDEX "_newsletters_v_version_populated_authors_order_idx" ON "_newsletters_v_version_populated_authors" USING btree ("_order");
  CREATE INDEX "_newsletters_v_version_populated_authors_parent_id_idx" ON "_newsletters_v_version_populated_authors" USING btree ("_parent_id");
  CREATE INDEX "_newsletters_v_parent_idx" ON "_newsletters_v" USING btree ("parent_id");
  CREATE INDEX "_newsletters_v_version_version_hero_image_idx" ON "_newsletters_v" USING btree ("version_hero_image_id");
  CREATE INDEX "_newsletters_v_version_version_predesigned_p_d_f_idx" ON "_newsletters_v" USING btree ("version_predesigned_p_d_f_id");
  ...
  CREATE INDEX "_newsletters_v_rels_users_id_idx" ON "_newsletters_v_rels" USING btree ("users_id");
  ...
  CREATE INDEX "subscribers_rels_subscriber_groups_id_idx" ON "subscribers_rels" USING btree ("subscriber_groups_id");
  CREATE UNIQUE INDEX "subscriber_groups_name_idx" ON "subscriber_groups" USING btree ("name");
  CREATE INDEX "subscriber_groups_updated_at_idx" ON "subscriber_groups" USING btree ("updated_at");
  CREATE INDEX "subscriber_groups_created_at_idx" ON "subscriber_groups" USING btree ("created_at");
  CREATE INDEX "newsletter_logs_newsletter_idx" ON "newsletter_logs" USING btree ("newsletter_id");
  CREATE INDEX "newsletter_logs_subscriber_idx" ON "newsletter_logs" USING btree ("subscriber_id");
  CREATE INDEX "newsletter_logs_updated_at_idx" ON "newsletter_logs" USING btree ("updated_at");
  CREATE INDEX "newsletter_logs_created_at_idx" ON "newsletter_logs" USING btree ("created_at");
  ...
  CREATE INDEX "payload_locked_documents_rels_subscriber_groups_id_idx" ON "payload_locked_documents_rels" USING btree ("subscriber_groups_id");
  CREATE INDEX "payload_locked_documents_rels_newsletter_logs_id_idx" ON "payload_locked_documents_rels" USING btree ("newsletter_logs_id");
  ...
  CREATE INDEX "header_nav_items_sub_menu_items_order_idx" ON "header_nav_items_sub_menu_items" USING btree ("_order");
  CREATE INDEX "header_nav_items_sub_menu_items_parent_id_idx" ON "header_nav_items_sub_menu_items" USING btree ("_parent_id");
  ...
  CREATE INDEX "footer_more_links_order_idx" ON "footer_more_links" USING btree ("_order");
  CREATE INDEX "footer_more_links_parent_id_idx" ON "footer_more_links" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_client_testimonials_testimonials" CASCADE;
  DROP TABLE "pages_blocks_client_testimonials" CASCADE;
  DROP TABLE "pages_blocks_newsletter_subscription_notes" CASCADE;
  DROP TABLE "pages_blocks_newsletter_subscription" CASCADE;
  DROP TABLE "pages_blocks_contact_form" CASCADE;
  DROP TABLE "pages_blocks_list_one_lists" CASCADE;
  DROP TABLE "pages_blocks_list_one" CASCADE;
  DROP TABLE "pages_blocks_list_two_lists" CASCADE;
  DROP TABLE "pages_blocks_list_two" CASCADE;
  DROP TABLE "pages_blocks_paragraph_one" CASCADE;
  DROP TABLE "pages_blocks_block_quote" CASCADE;
  DROP TABLE "pages_blocks_address" CASCADE;
  DROP TABLE "pages_blocks_registration_form" CASCADE;
  DROP TABLE "pages_blocks_about_us_list" CASCADE;
  DROP TABLE "pages_blocks_about_us" CASCADE;
  DROP TABLE "pages_blocks_accordion_accordion" CASCADE;
  DROP TABLE "pages_blocks_accordion" CASCADE;
  DROP TABLE "pages_blocks_gallery_images" CASCADE;
  DROP TABLE "pages_blocks_gallery" CASCADE;
  DROP TABLE "pages_blocks_you_tube_video" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_client_testimonials_testimonials" CASCADE;
  DROP TABLE "_pages_v_blocks_client_testimonials" CASCADE;
  DROP TABLE "_pages_v_blocks_newsletter_subscription_notes" CASCADE;
  DROP TABLE "_pages_v_blocks_newsletter_subscription" CASCADE;
  DROP TABLE "_pages_v_blocks_contact_form" CASCADE;
  DROP TABLE "_pages_v_blocks_list_one_lists" CASCADE;
  DROP TABLE "_pages_v_blocks_list_one" CASCADE;
  DROP TABLE "_pages_v_blocks_list_two_lists" CASCADE;
  DROP TABLE "_pages_v_blocks_list_two" CASCADE;
  DROP TABLE "_pages_v_blocks_paragraph_one" CASCADE;
  DROP TABLE "_pages_v_blocks_block_quote" CASCADE;
  DROP TABLE "_pages_v_blocks_address" CASCADE;
  DROP TABLE "_pages_v_blocks_registration_form" CASCADE;
  DROP TABLE "_pages_v_blocks_about_us_list" CASCADE;
  DROP TABLE "_pages_v_blocks_about_us" CASCADE;
  DROP TABLE "_pages_v_blocks_accordion_accordion" CASCADE;
  DROP TABLE "_pages_v_blocks_accordion" CASCADE;
  DROP TABLE "_pages_v_blocks_gallery_images" CASCADE;
  DROP TABLE "_pages_v_blocks_gallery" CASCADE;
  DROP TABLE "_pages_v_blocks_you_tube_video" CASCADE;
  ...
  DROP TABLE "newsletters_populated_authors" CASCADE;
  DROP TABLE "newsletters" CASCADE;
  DROP TABLE "newsletters_rels" CASCADE;
  DROP TABLE "_newsletters_v_version_populated_authors" CASCADE;
  DROP TABLE "_newsletters_v" CASCADE;
  DROP TABLE "_newsletters_v_rels" CASCADE;
  DROP TABLE "subscribers" CASCADE;
  DROP TABLE "subscribers_rels" CASCADE;
  DROP TABLE "subscriber_groups" CASCADE;
  DROP TABLE "newsletter_logs" CASCADE;
  ...
  DROP TABLE "header_nav_items_sub_menu_items" CASCADE;
  DROP TABLE "header_nav_items" CASCADE;
  DROP TABLE "header" CASCADE;
  DROP TABLE "header_rels" CASCADE;
  DROP TABLE "footer_more_links" CASCADE;
  DROP TABLE "footer" CASCADE;
  DROP TABLE "footer_rels" CASCADE;
  DROP TABLE "settings" CASCADE;
  DROP TABLE "sambodhi_retreat_centre" CASCADE;
  ...
  DROP TYPE "public"."enum_newsletter_logs_status";
  ...
  DROP TYPE "public"."enum_header_nav_items_sub_menu_items_link_type";
  DROP TYPE "public"."enum_header_nav_items_link_type";
  DROP TYPE "public"."enum_footer_more_links_link_type";
  DROP TYPE "public"."enum_settings_newsletter_subscriber_group_mode";`)
}

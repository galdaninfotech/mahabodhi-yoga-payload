...
import { PageNavigationProgress } from '@/components/PageNavigationProgress'
  ...
  return (
    ...
    >
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Big+Shoulders+Display:wght@100..900&family=PT+Sans+Narrow:wght@400;700&family=Pinyon+Script&display=swap" rel="stylesheet" />

...
export const coursesRetreatsPageData: (
  args: PageArgs,
) => RequiredDataFromCollectionSlug<'pages'> = ({ mediaMap, contactForm }) => {
  console.log('Seeding yoga-courses-and-retreats page data...')
  ...
  return {
    ...
    layout: [

      {
        ...
        media: mediaMap['yoga-courses-and-retreats.jpg'],
        content: {
          root: {
            type: 'root',
            format: '',
    ...
    meta: {
      ...
      image: mediaMap['yoga-courses-and-retreats.jpg'],

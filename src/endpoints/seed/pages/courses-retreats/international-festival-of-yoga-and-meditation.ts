...
export const internationalFestivalPageData: (
  ...
  console.log('Seeding international-festival-of-yoga-and-meditation page data...')
  ...
  return {
    ...
    layout: [
      {
        ...
        media: mediaMap['international-festival-of-yoga-and-meditation.jpg'],
        content: {
          root: {
            type: 'root',
            format: '',
    ...
    meta: {
      ...
      image: mediaMap['international-festival-of-yoga-and-meditation.jpg'],

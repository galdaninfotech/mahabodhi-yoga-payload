...
export const regularYogaPageData: (args: PageArgs) => RequiredDataFromCollectionSlug<'pages'> = ({ mediaMap, contactForm }) => {

  console.log('Seeding regular-yoga-and-meditation page data...')
  ...
  return {
    ...
    layout: [
      {
        ...
        media: mediaMap['regular-yoga-and-meditation.jpg'],
        content: {
          root: {
            type: 'root',
            format: '',
    ...
    meta: {
      ...
      image: mediaMap['regular-yoga-and-meditation.jpg'],
      title: 'Regular Yoga & Meditation',
    },
    title: 'Regular Yoga & Meditation',
  }

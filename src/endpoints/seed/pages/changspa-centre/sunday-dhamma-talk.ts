...
export const dhammaTalkPageData: (args: PageArgs) => RequiredDataFromCollectionSlug<'pages'> = ({ mediaMap, contactForm }) => {

  console.log('Seeding sunday-dhamma-talk page data...')
  ...
  return {
    ...
    layout: [
      {
        ...
        media: mediaMap['sunday-dhamma-talk.jpg'],
        content: {
          root: {
            type: 'root',
            format: '',
    ...
    meta: {
      ...
      image: mediaMap['sunday-dhamma-talk.jpg'],
      title: 'Sunday Dhamma Talk',
    },
    title: 'Sunday Dhamma Talk',
  }
